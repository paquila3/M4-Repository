 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Peter Aquila");
		  toPrint += p1.toString("902776525");
		  //Person2 replace P2 with your name
		  //and ggg000x with your gt num
		  Person2 p2 = new Person2("Cory Walker");
		  toPrint += p2.toString("902740514");
          ...
          //and ggg000x with your gt num
          Person4 p4 = new Person4("Timothy Kierzkowski");
          toPrint += p4.toString("902747446");
